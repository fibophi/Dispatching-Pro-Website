            ...
            <div className="flex flex-wrap gap-2 md:gap-4 justify-center">
              {categories.map((category) => (
                <Button
                  ...
                  className={
                    category === "All"
                      ? "bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold text-xs md:text-sm px-3 py-2 md:px-4 md:py-2"
                      : "border-gray-600 text-gray-300 hover:border-yellow-400 hover:text-yellow-400 bg-transparent text-xs md:text-sm px-3 py-2 md:px-4 md:py-2"
                  }
                >
                  {category}
                </Button>
                  ...
                  <Card key={post.id} className="bg-gray-900 border-2 border-gray-700 hover:border-yellow-400 transition-colors overflow-hidden group">
                    <CardContent className="p-4 md:p-6">
                      <div className="absolute top-4 left-4">
                        <span className="bg-gray-900 bg-opacity-90 text-yellow-400 px-2 md:px-3 py-1 rounded-full text-xs md:text-sm font-bold flex items-center">
                          <IconComponent className="h-3 w-3 mr-1" />
                          {post.category}
                        </span>
                      </div>
                      <h3 className="text-lg md:text-xl font-black text-white mb-3 group-hover:text-yellow-400 transition-colors pt-8 md:pt-6">
                        {post.title}
                      </h3>
                      <p className="text-gray-300 mb-4 line-clamp-3 text-sm md:text-base">{post.excerpt}</p>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button size="sm" className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold text-xs md:text-sm px-3 py-1">
