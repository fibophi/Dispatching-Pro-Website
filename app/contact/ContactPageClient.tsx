                ...
                <CardContent className="p-6 md:p-8">
                  {submitStatus === "success" && (
                    <div className="mb-6 p-4 bg-green-900 border border-green-700 rounded-lg flex items-center">
                      ...
                      <p className="text-green-300">
                        Message sent successfully! We'll get back to you within the hour.
                      </p>
                    </div>
                  )}
                  ...
                  {submitStatus === "error" && (
                    <div className="mb-6 p-4 bg-red-900 border border-red-700 rounded-lg flex items-center">
                      ...
                      <p className="text-red-300">
                        Failed to send message. Please try calling us directly at 647-362-6649.
                      </p>
                    </div>
                  )}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                    ...
                    <Button
                      ...
                      className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-black py-3 text-base md:text-lg disabled:opacity-50"
                    >
