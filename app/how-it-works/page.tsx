          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:hidden space-y-6">
              ...
              <div className="text-center">
                ...
                <Card className="bg-gray-900 border-2 border-blue-500 mx-auto max-w-sm">
              ...
              <div className="text-center">
                ...
                <Card className="bg-gray-900 border-2 border-red-500 mx-auto max-w-sm">
                  <CardContent className="p-6 text-center">
                    <div className="bg-red-500 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                      <FileText className="h-8 w-8 text-white" />
                    </div>
              ...
              <div className="text-center">
                ...
                <Card className="bg-gray-900 border-2 border-yellow-400 mx-auto max-w-sm">
                  <CardContent className="p-6 text-center">
                    <div className="bg-yellow-400 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                      <TrendingUp className="h-8 w-8 text-gray-900" />
                    </div>
              ...
              <div className="text-center">
                ...
                <Card className="bg-gray-900 border-2 border-green-500 mx-auto max-w-sm">
                  <CardContent className="p-6 text-center">
                    <div className="bg-green-500 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                      <Rocket className="h-8 w-8 text-white" />
                    </div>
